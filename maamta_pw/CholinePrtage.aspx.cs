...
namespace maamta_pw
{
    public partial class CholinePrtage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Session["WebForm"] = "CholinePrtage";
                GraphColor();

                txtCalndrDate_Choline.Attributes.Add("readonly", "readonly");
                txtCalndrDate_Choline.Text = DateTime.Now.ToString("dd-MM-yyyy");
        ...
        {
            GridView2.Caption = "<h4>Selected Choline Date: (" + txtCalndrDate_Choline.Text + ")</h4>";
        ...
        {
            string query = string.Format("SELECT 'Greater than 75.0%' AS FIELD,COUNT(study_code) AS total FROM (SELECT a.study_code,Consumed_Choline, (DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y'))) AS Need_to_be_used, (CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END)AS percentage    FROM   form_crf_3a AS a LEFT JOIN  (SELECT z.study_code, SUM(z.pw_crf4b_18b_qty) AS Consumed_Choline FROM form_crf_4b AS z GROUP BY z.study_code ) AS TableA  ON a.study_code=TableA.study_code  LEFT JOIN  (SELECT study_code, pw_crf_3a_19 AS arm,DATE_FORMAT(STR_TO_DATE(pw_crf_3a_2,'%d-%m-%Y'),'%d-%m-%Y')  AS date_of_registration FROM form_crf_3a) AS TableB ON TableA.study_code=TableB.study_code LEFT JOIN  (SELECT study_code, DATE_FORMAT(MAX(STR_TO_DATE(pw_crf4b_2,'%d-%m-%Y')),'%d-%m-%Y') AS last_DOV FROM form_crf_4b GROUP BY study_code)AS TableC ON TableA.study_code=TableC.study_code  WHERE pw_crf_3a_19=4) AS Table_F WHERE percentage  >=75.0   UNION ALL SELECT 'Between 70.0% to 74.9%' AS FIELD,COUNT(study_code) AS total FROM (SELECT a.study_code,Consumed_Choline, (DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y'))) AS Need_to_be_used, (CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END)AS percentage    FROM   form_crf_3a AS a LEFT JOIN  (SELECT z.study_code, SUM(z.pw_crf4b_18b_qty) AS Consumed_Choline FROM form_crf_4b AS z GROUP BY z.study_code ) AS TableA  ON a.study_code=TableA.study_code  LEFT JOIN  (SELECT study_code, pw_crf_3a_19 AS arm,DATE_FORMAT(STR_TO_DATE(pw_crf_3a_2,'%d-%m-%Y'),'%d-%m-%Y')  AS date_of_registration FROM form_crf_3a) AS TableB ON TableA.study_code=TableB.study_code LEFT JOIN  (SELECT study_code, DATE_FORMAT(MAX(STR_TO_DATE(pw_crf4b_2,'%d-%m-%Y')),'%d-%m-%Y') AS last_DOV FROM form_crf_4b GROUP BY study_code)AS TableC ON TableA.study_code=TableC.study_code  	LEFT JOIN (SELECT * FROM (SELECT b.form_crf_1_id,b.`pw_id`,b.`pw_assist_code`,	 DATE_SUB((STR_TO_DATE(b.pw_crf1_02, '%d-%m-%Y')), INTERVAL ((c.pw_crf_1_30_week*7)+c.pw_crf_1_30_days)  DAY) AS LMP  FROM form_crf_1 AS b LEFT JOIN ultrasound_examination AS c ON c.form_crf1_id=b.form_crf_1_id ) AS a WHERE a.form_crf_1_id IN (SELECT MIN(z.form_crf_1_id) FROM form_crf_1 AS z GROUP BY z.pw_assist_code)) AS ea ON ea.pw_id=a.pw_id			WHERE pw_crf_3a_19=4) AS Table_F WHERE percentage  BETWEEN 70.0 AND 74.9 UNION ALL SELECT 'Between 60.0% to 69.9%' AS FIELD,COUNT(study_code) AS total FROM (SELECT a.study_code,Consumed_Choline, (DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y'))) AS Need_to_be_used, (CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END)AS percentage    FROM   form_crf_3a AS a LEFT JOIN  (SELECT z.study_code, SUM(z.pw_crf4b_18b_qty) AS Consumed_Choline FROM form_crf_4b AS z GROUP BY z.study_code ) AS TableA  ON a.study_code=TableA.study_code  LEFT JOIN  (SELECT study_code, pw_crf_3a_19 AS arm,DATE_FORMAT(STR_TO_DATE(pw_crf_3a_2,'%d-%m-%Y'),'%d-%m-%Y')  AS date_of_registration FROM form_crf_3a) AS TableB ON TableA.study_code=TableB.study_code LEFT JOIN  (SELECT study_code, DATE_FORMAT(MAX(STR_TO_DATE(pw_crf4b_2,'%d-%m-%Y')),'%d-%m-%Y') AS last_DOV FROM form_crf_4b GROUP BY study_code)AS TableC ON TableA.study_code=TableC.study_code  WHERE pw_crf_3a_19=4) AS Table_F WHERE percentage  BETWEEN 60.0 AND 69.9 UNION ALL SELECT 'Between 50.1% to 59.9%' AS FIELD,COUNT(study_code) AS total FROM (SELECT a.study_code,Consumed_Choline, (DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y'))) AS Need_to_be_used, (CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END)AS percentage    FROM   form_crf_3a AS a LEFT JOIN  (SELECT z.study_code, SUM(z.pw_crf4b_18b_qty) AS Consumed_Choline FROM form_crf_4b AS z GROUP BY z.study_code ) AS TableA  ON a.study_code=TableA.study_code  LEFT JOIN  (SELECT study_code, pw_crf_3a_19 AS arm,DATE_FORMAT(STR_TO_DATE(pw_crf_3a_2,'%d-%m-%Y'),'%d-%m-%Y')  AS date_of_registration FROM form_crf_3a) AS TableB ON TableA.study_code=TableB.study_code LEFT JOIN  (SELECT study_code, DATE_FORMAT(MAX(STR_TO_DATE(pw_crf4b_2,'%d-%m-%Y')),'%d-%m-%Y') AS last_DOV FROM form_crf_4b GROUP BY study_code)AS TableC ON TableA.study_code=TableC.study_code  WHERE pw_crf_3a_19=4) AS Table_F WHERE percentage  BETWEEN 50.1 AND 59.9 UNION ALL SELECT 'Less than 50.0%' AS FIELD,COUNT(study_code) AS total FROM (SELECT a.study_code,Consumed_Choline, (DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y'))) AS Need_to_be_used, (CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END)AS percentage    FROM   form_crf_3a AS a LEFT JOIN  (SELECT z.study_code, SUM(z.pw_crf4b_18b_qty) AS Consumed_Choline FROM form_crf_4b AS z GROUP BY z.study_code ) AS TableA  ON a.study_code=TableA.study_code  LEFT JOIN  (SELECT study_code, pw_crf_3a_19 AS arm,DATE_FORMAT(STR_TO_DATE(pw_crf_3a_2,'%d-%m-%Y'),'%d-%m-%Y')  AS date_of_registration FROM form_crf_3a) AS TableB ON TableA.study_code=TableB.study_code LEFT JOIN  (SELECT study_code, DATE_FORMAT(MAX(STR_TO_DATE(pw_crf4b_2,'%d-%m-%Y')),'%d-%m-%Y') AS last_DOV FROM form_crf_4b GROUP BY study_code)AS TableC ON TableA.study_code=TableC.study_code  WHERE pw_crf_3a_19=4) AS Table_F WHERE percentage  <=50.0");

            // (02-09-2020)   Consumed Query and Add Total Consumed Choline              
            // string query = string.Format("SELECT 'Greater than 75.0%' AS FIELD, COUNT(c.study_code) AS 'total'				FROM 		pregnant_woman AS a LEFT JOIN  studies AS c ON c.pw_id=a.pw_id LEFT JOIN form_crf_3a AS d ON d.pw_id=a.pw_id	  WHERE	c.study_code IS NOT NULL AND d.pw_crf_3a_19!='1' AND		  (SELECT (((SELECT SUM(z.pw_crf4b_18b_qty) FROM form_crf_4b AS z WHERE z.study_code=ax.study_code)/(DATEDIFF(STR_TO_DATE(ax.pw_crf4b_2, '%d-%m-%Y'), STR_TO_DATE(ay.pw_crf_3a_2, '%d-%m-%Y'))  )	)*100) 		FROM 		(SELECT * FROM form_crf_4b AS xx WHERE xx.`form4b_id` IN (SELECT MAX(form4b_id) FROM form_crf_4b GROUP BY study_code)) AS ax LEFT JOIN  form_crf_3a AS ay ON ax.`study_code`=ay.`study_code` WHERE ax.study_id=c.study_id GROUP BY ax.study_id)  >=75.0  	UNION ALL SELECT 'Between 70.0% to 74.9%' AS FIELD, COUNT(c.study_code) AS 'total'		FROM 		pregnant_woman AS a LEFT JOIN  studies AS c ON c.pw_id=a.pw_id LEFT JOIN form_crf_3a AS d ON d.pw_id=a.pw_id	  WHERE c.study_code IS NOT NULL AND d.pw_crf_3a_19!='1' AND		  (SELECT (((SELECT SUM(z.pw_crf4b_18b_qty) FROM form_crf_4b AS z WHERE z.study_code=ax.study_code)/(DATEDIFF(STR_TO_DATE(ax.pw_crf4b_2, '%d-%m-%Y'), STR_TO_DATE(ay.pw_crf_3a_2, '%d-%m-%Y'))  )	)*100) 		FROM 		(SELECT * FROM form_crf_4b AS xx WHERE xx.`form4b_id` IN (SELECT MAX(form4b_id) FROM form_crf_4b GROUP BY study_code)) AS ax LEFT JOIN  form_crf_3a AS ay ON ax.`study_code`=ay.`study_code` WHERE ax.study_id=c.study_id GROUP BY ax.study_id)  BETWEEN 70.0 AND 74.9  	UNION ALL SELECT 'Between 60.0% to 69.9%' AS FIELD, COUNT(c.study_code) AS 'total'		FROM 		pregnant_woman AS a LEFT JOIN  studies AS c ON c.pw_id=a.pw_id LEFT JOIN form_crf_3a AS d ON d.pw_id=a.pw_id	  WHERE c.study_code IS NOT NULL AND d.pw_crf_3a_19!='1' AND		  (SELECT (((SELECT SUM(z.pw_crf4b_18b_qty) FROM form_crf_4b AS z WHERE z.study_code=ax.study_code)/(DATEDIFF(STR_TO_DATE(ax.pw_crf4b_2, '%d-%m-%Y'), STR_TO_DATE(ay.pw_crf_3a_2, '%d-%m-%Y'))  )	)*100) 		FROM 		(SELECT * FROM form_crf_4b AS xx WHERE xx.`form4b_id` IN (SELECT MAX(form4b_id) FROM form_crf_4b GROUP BY study_code)) AS ax LEFT JOIN  form_crf_3a AS ay ON ax.`study_code`=ay.`study_code` WHERE ax.study_id=c.study_id GROUP BY ax.study_id)  BETWEEN 60.0 AND 69.9  	UNION ALL SELECT 'Between 50.1% to 59.9%' AS FIELD, COUNT(c.study_code) AS 'total'		FROM 		pregnant_woman AS a LEFT JOIN  studies AS c ON c.pw_id=a.pw_id LEFT JOIN form_crf_3a AS d ON d.pw_id=a.pw_id	  WHERE c.study_code IS NOT NULL AND d.pw_crf_3a_19!='1' AND		  (SELECT (((SELECT SUM(z.pw_crf4b_18b_qty) FROM form_crf_4b AS z WHERE z.study_code=ax.study_code)/(DATEDIFF(STR_TO_DATE(ax.pw_crf4b_2, '%d-%m-%Y'), STR_TO_DATE(ay.pw_crf_3a_2, '%d-%m-%Y'))  )	)*100) 		FROM 		(SELECT * FROM form_crf_4b AS xx WHERE xx.`form4b_id` IN (SELECT MAX(form4b_id) FROM form_crf_4b GROUP BY study_code)) AS ax LEFT JOIN  form_crf_3a AS ay ON ax.`study_code`=ay.`study_code` WHERE ax.study_id=c.study_id GROUP BY ax.study_id)  BETWEEN 50.1 AND 59.9		UNION ALL SELECT 'Less and equal than 50.0%' AS FIELD, COUNT(c.study_code) AS 'total'		FROM 		pregnant_woman AS a LEFT JOIN  studies AS c ON c.pw_id=a.pw_id LEFT JOIN form_crf_3a AS d ON d.pw_id=a.pw_id	  WHERE c.study_code IS NOT NULL AND d.pw_crf_3a_19!='1' AND		  (SELECT (((SELECT SUM(z.pw_crf4b_18b_qty) FROM form_crf_4b AS z WHERE z.study_code=ax.study_code)/(DATEDIFF(STR_TO_DATE(ax.pw_crf4b_2, '%d-%m-%Y'), STR_TO_DATE(ay.pw_crf_3a_2, '%d-%m-%Y'))  )	)*100) 		FROM 		(SELECT * FROM form_crf_4b AS xx WHERE xx.`form4b_id` IN (SELECT MAX(form4b_id) FROM form_crf_4b GROUP BY study_code)) AS ax LEFT JOIN  form_crf_3a AS ay ON ax.`study_code`=ay.`study_code` WHERE ax.study_id=c.study_id GROUP BY ax.study_id)  <=50.0 ");
        ...
        public void ExcelExport()
        {
            ...
            {
                Response.Clear();
                Response.AddHeader("content-disposition", "attachment;filename=Choline Cumulative (" + DateTime.Today.ToString("dd-MM-yyyy") + ").xls");
                Response.Charset = "";
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                cmd = new MySqlCommand("SELECT c.study_code,(CASE WHEN e.`study_code`!='' THEN 		CONCAT(SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP)/7),'.',1)		,'.',    SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP)),'.',1)-SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP))/7,'.',1)*7) 	ELSE 			CONCAT(SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP)/7),'.',1)		,'.',    SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP)),'.',1)-SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP))/7,'.',1)*7) END) AS gestational_age,					(CASE WHEN e.`study_code`!='' THEN 'Outcome Filled' ELSE 'Ongoing' END) AS Pregnancy_Status 	,   CONCAT(a.pw_crf_1_11,a.pw_crf_1_12,a.pw_crf_1_13,a.pw_crf_1_14,a.pw_crf_1_15,a.pw_crf_1_16) AS dssid,a.pw_crf_1_09 AS woman_nm,a.pw_crf_1_10 AS husband_nm		, 				(SELECT COUNT(z.study_id) FROM form_crf_4b AS z WHERE z.study_id=c.study_id) AS CRF4b_Attempt,		(SELECT COUNT(z.study_id) FROM form_crf_4b AS z WHERE z.study_id=c.study_id AND z.pw_crf4b_14='1') AS CRF4b_Complete, 				 last_DOV, (CASE WHEN Consumed_Choline IS NULL THEN 0 	ELSE	 Consumed_Choline END ) AS Consumed_Choline,  (DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y'))) AS Need_to_be_used, CONCAT((CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END),'%')			AS percentage FROM   pregnant_woman AS a LEFT JOIN  studies AS c ON c.pw_id=a.pw_id LEFT JOIN form_crf_3a AS d ON d.pw_id=a.pw_id LEFT JOIN form_crf_6a AS e ON e.`study_code`=d.`study_code`   		   LEFT JOIN (SELECT z.study_code, SUM(z.pw_crf4b_18b_qty) AS Consumed_Choline FROM form_crf_4b AS z GROUP BY z.study_code ) AS TableA  ON c.study_code=TableA.study_code  LEFT JOIN  (SELECT study_code, pw_crf_3a_19 AS arm,DATE_FORMAT(STR_TO_DATE(pw_crf_3a_2,'%d-%m-%Y'),'%d-%m-%Y')  AS date_of_registration FROM form_crf_3a) AS TableB ON TableA.study_code=TableB.study_code LEFT JOIN  (SELECT study_code, DATE_FORMAT(MAX(STR_TO_DATE(pw_crf4b_2,'%d-%m-%Y')),'%d-%m-%Y') AS last_DOV FROM form_crf_4b GROUP BY study_code)AS TableC ON TableA.study_code=TableC.study_code  	LEFT JOIN (SELECT * FROM (SELECT b.form_crf_1_id,b.`pw_id`,b.`pw_assist_code`,	 DATE_SUB((STR_TO_DATE(b.pw_crf1_02, '%d-%m-%Y')), INTERVAL ((c.pw_crf_1_30_week*7)+c.pw_crf_1_30_days)  DAY) AS LMP  FROM form_crf_1 AS b LEFT JOIN ultrasound_examination AS c ON c.form_crf1_id=b.form_crf_1_id ) AS a WHERE a.form_crf_1_id IN (SELECT MIN(z.form_crf_1_id) FROM form_crf_1 AS z GROUP BY z.pw_assist_code)) AS ea ON ea.pw_id=a.pw_id			        WHERE c.study_code IS NOT NULL AND  d.pw_crf_3a_19='4'  AND CONCAT(a.pw_crf_1_11,a.pw_crf_1_12,a.pw_crf_1_13,a.pw_crf_1_14,a.pw_crf_1_15,a.pw_crf_1_16)  LIKE '%" + txtdssid.Text.ToUpper() + "%'  ORDER BY c.study_code;", con);
        ...
        private void ShowGraphGridViewR1()
        {
            ...
            try
            {
                con.Open();
                MySqlCommand cmd;
                cmd = new MySqlCommand("SELECT c.study_code,(CASE WHEN e.`study_code`!='' THEN 		CONCAT(SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP)/7),'.',1)		,'.',    SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP)),'.',1)-SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP))/7,'.',1)*7) 	ELSE 			CONCAT(SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP)/7),'.',1)		,'.',    SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP)),'.',1)-SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP))/7,'.',1)*7) END) AS gestational_age,					(CASE WHEN e.`study_code`!='' THEN 'Outcome Filled' ELSE 'Ongoing' END) AS Pregnancy_Status 	,CONCAT(a.pw_crf_1_11,a.pw_crf_1_12,a.pw_crf_1_13,a.pw_crf_1_14,a.pw_crf_1_15,a.pw_crf_1_16) AS dssid,a.pw_crf_1_09 AS woman_nm,a.pw_crf_1_10 AS husband_nm, 				 last_DOV, (CASE WHEN Consumed_Choline IS NULL THEN 0 	ELSE	 Consumed_Choline END ) AS Consumed_Choline,  (DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y'))) AS Need_to_be_used, CONCAT((CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END),'%')			AS percentage FROM   pregnant_woman AS a LEFT JOIN  studies AS c ON c.pw_id=a.pw_id LEFT JOIN form_crf_3a AS d ON d.pw_id=a.pw_id LEFT JOIN form_crf_6a AS e ON e.`study_code`=d.`study_code`   		   LEFT JOIN (SELECT z.study_code, SUM(z.pw_crf4b_18b_qty) AS Consumed_Choline FROM form_crf_4b AS z GROUP BY z.study_code ) AS TableA  ON c.study_code=TableA.study_code  LEFT JOIN  (SELECT study_code, pw_crf_3a_19 AS arm,DATE_FORMAT(STR_TO_DATE(pw_crf_3a_2,'%d-%m-%Y'),'%d-%m-%Y')  AS date_of_registration FROM form_crf_3a) AS TableB ON TableA.study_code=TableB.study_code LEFT JOIN  (SELECT study_code, DATE_FORMAT(MAX(STR_TO_DATE(pw_crf4b_2,'%d-%m-%Y')),'%d-%m-%Y') AS last_DOV FROM form_crf_4b GROUP BY study_code)AS TableC ON TableA.study_code=TableC.study_code 	LEFT JOIN (SELECT * FROM (SELECT b.form_crf_1_id,b.`pw_id`,b.`pw_assist_code`,	 DATE_SUB((STR_TO_DATE(b.pw_crf1_02, '%d-%m-%Y')), INTERVAL ((c.pw_crf_1_30_week*7)+c.pw_crf_1_30_days)  DAY) AS LMP  FROM form_crf_1 AS b LEFT JOIN ultrasound_examination AS c ON c.form_crf1_id=b.form_crf_1_id ) AS a WHERE a.form_crf_1_id IN (SELECT MIN(z.form_crf_1_id) FROM form_crf_1 AS z GROUP BY z.pw_assist_code)) AS ea ON ea.pw_id=a.pw_id			 WHERE c.study_code IS NOT NULL AND  d.pw_crf_3a_19='4'  AND (CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END) >=75.0", con);

                // (02-09-2020)       modify Query        
                // cmd = new MySqlCommand("SELECT c.study_code,CONCAT(a.pw_crf_1_11,a.pw_crf_1_12,a.pw_crf_1_13,a.pw_crf_1_14,a.pw_crf_1_15,a.pw_crf_1_16) AS dssid,a.pw_crf_1_09 AS woman_nm,a.pw_crf_1_10 AS husband_nm, 				(SELECT COUNT(z.study_id) FROM form_crf_4b AS z WHERE z.study_id=c.study_id) AS CRF4b_Attempt,		(SELECT COUNT(z.study_id) FROM form_crf_4b AS z WHERE z.study_id=c.study_id AND z.pw_crf4b_14='1') AS CRF4b_Complete		,(SELECT CONCAT(ROUND ( (((SELECT SUM(z.pw_crf4b_18b_qty) FROM form_crf_4b AS z WHERE z.study_code=ax.study_code)/(DATEDIFF(STR_TO_DATE(ax.pw_crf4b_2, '%d-%m-%Y'), STR_TO_DATE(ay.pw_crf_3a_2, '%d-%m-%Y'))  )	)*100) ,1),'%')		FROM 		(SELECT * FROM form_crf_4b AS xx WHERE xx.`form4b_id` IN (SELECT MAX(form4b_id) FROM form_crf_4b GROUP BY study_code)) AS ax LEFT JOIN  form_crf_3a AS ay ON ax.`study_code`=ay.`study_code` WHERE ax.study_id=c.study_id GROUP BY ax.study_id)  AS Cumulative_Choline ,	(CASE WHEN e.`study_code`!='' THEN 'Outcome Filled' ELSE 'Ongoing' END) AS Pregnancy_Status 	 				FROM 		pregnant_woman AS a LEFT JOIN  studies AS c ON c.pw_id=a.pw_id LEFT JOIN form_crf_3a AS d ON d.pw_id=a.pw_id LEFT JOIN form_crf_6a AS e ON e.`study_code`=d.`study_code`   		  WHERE c.study_code IS NOT NULL AND  d.pw_crf_3a_19='4' AND 		(SELECT (((SELECT SUM(z.pw_crf4b_18b_qty) FROM form_crf_4b AS z WHERE z.study_code=ax.study_code)/(DATEDIFF(STR_TO_DATE(ax.pw_crf4b_2, '%d-%m-%Y'), STR_TO_DATE(ay.pw_crf_3a_2, '%d-%m-%Y'))  )	)*100) 		FROM 		(SELECT * FROM form_crf_4b AS xx WHERE xx.`form4b_id` IN (SELECT MAX(form4b_id) FROM form_crf_4b GROUP BY study_code)) AS ax LEFT JOIN  form_crf_3a AS ay ON ax.`study_code`=ay.`study_code` WHERE ax.study_id=c.study_id GROUP BY ax.study_id)         >=75.0		ORDER BY c.study_code;", con);
                MySqlDataAdapter sda = new MySqlDataAdapter();
                {
                    cmd.Connection = con;
                    cmd.CommandTimeout = 9999999;
        ...
        private void ShowGraphGridViewR2()
        {
            ...
            try
            {
                con.Open();
                MySqlCommand cmd;
                cmd = new MySqlCommand("SELECT c.study_code,(CASE WHEN e.`study_code`!='' THEN 		CONCAT(SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP)/7),'.',1)		,'.',    SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP)),'.',1)-SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP))/7,'.',1)*7) 	ELSE 			CONCAT(SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP)/7),'.',1)		,'.',    SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP)),'.',1)-SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP))/7,'.',1)*7) END) AS gestational_age,					(CASE WHEN e.`study_code`!='' THEN 'Outcome Filled' ELSE 'Ongoing' END) AS Pregnancy_Status 	,CONCAT(a.pw_crf_1_11,a.pw_crf_1_12,a.pw_crf_1_13,a.pw_crf_1_14,a.pw_crf_1_15,a.pw_crf_1_16) AS dssid,a.pw_crf_1_09 AS woman_nm,a.pw_crf_1_10 AS husband_nm, 				 last_DOV, (CASE WHEN Consumed_Choline IS NULL THEN 0 	ELSE	 Consumed_Choline END ) AS Consumed_Choline,  (DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y'))) AS Need_to_be_used, CONCAT((CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END),'%')			AS percentage FROM   pregnant_woman AS a LEFT JOIN  studies AS c ON c.pw_id=a.pw_id LEFT JOIN form_crf_3a AS d ON d.pw_id=a.pw_id LEFT JOIN form_crf_6a AS e ON e.`study_code`=d.`study_code`   		   LEFT JOIN (SELECT z.study_code, SUM(z.pw_crf4b_18b_qty) AS Consumed_Choline FROM form_crf_4b AS z GROUP BY z.study_code ) AS TableA  ON c.study_code=TableA.study_code  LEFT JOIN  (SELECT study_code, pw_crf_3a_19 AS arm,DATE_FORMAT(STR_TO_DATE(pw_crf_3a_2,'%d-%m-%Y'),'%d-%m-%Y')  AS date_of_registration FROM form_crf_3a) AS TableB ON TableA.study_code=TableB.study_code LEFT JOIN  (SELECT study_code, DATE_FORMAT(MAX(STR_TO_DATE(pw_crf4b_2,'%d-%m-%Y')),'%d-%m-%Y') AS last_DOV FROM form_crf_4b GROUP BY study_code)AS TableC ON TableA.study_code=TableC.study_code 	LEFT JOIN (SELECT * FROM (SELECT b.form_crf_1_id,b.`pw_id`,b.`pw_assist_code`,	 DATE_SUB((STR_TO_DATE(b.pw_crf1_02, '%d-%m-%Y')), INTERVAL ((c.pw_crf_1_30_week*7)+c.pw_crf_1_30_days)  DAY) AS LMP  FROM form_crf_1 AS b LEFT JOIN ultrasound_examination AS c ON c.form_crf1_id=b.form_crf_1_id ) AS a WHERE a.form_crf_1_id IN (SELECT MIN(z.form_crf_1_id) FROM form_crf_1 AS z GROUP BY z.pw_assist_code)) AS ea ON ea.pw_id=a.pw_id			 WHERE c.study_code IS NOT NULL AND  d.pw_crf_3a_19='4'  AND (CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END) between 70.0 and 74.9", con);
        ...
        private void ShowGraphGridViewR3()
        {
            ...
            try
            {
                con.Open();
                MySqlCommand cmd;
                cmd = new MySqlCommand("SELECT c.study_code,(CASE WHEN e.`study_code`!='' THEN 		CONCAT(SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP)/7),'.',1)		,'.',    SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP)),'.',1)-SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP))/7,'.',1)*7) 	ELSE 			CONCAT(SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP)/7),'.',1)		,'.',    SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP)),'.',1)-SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP))/7,'.',1)*7) END) AS gestational_age,					(CASE WHEN e.`study_code`!='' THEN 'Outcome Filled' ELSE 'Ongoing' END) AS Pregnancy_Status 	,CONCAT(a.pw_crf_1_11,a.pw_crf_1_12,a.pw_crf_1_13,a.pw_crf_1_14,a.pw_crf_1_15,a.pw_crf_1_16) AS dssid,a.pw_crf_1_09 AS woman_nm,a.pw_crf_1_10 AS husband_nm, 				 last_DOV, (CASE WHEN Consumed_Choline IS NULL THEN 0 	ELSE	 Consumed_Choline END ) AS Consumed_Choline,  (DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y'))) AS Need_to_be_used, CONCAT((CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END),'%')			AS percentage FROM   pregnant_woman AS a LEFT JOIN  studies AS c ON c.pw_id=a.pw_id LEFT JOIN form_crf_3a AS d ON d.pw_id=a.pw_id LEFT JOIN form_crf_6a AS e ON e.`study_code`=d.`study_code`   		   LEFT JOIN (SELECT z.study_code, SUM(z.pw_crf4b_18b_qty) AS Consumed_Choline FROM form_crf_4b AS z GROUP BY z.study_code ) AS TableA  ON c.study_code=TableA.study_code  LEFT JOIN  (SELECT study_code, pw_crf_3a_19 AS arm,DATE_FORMAT(STR_TO_DATE(pw_crf_3a_2,'%d-%m-%Y'),'%d-%m-%Y')  AS date_of_registration FROM form_crf_3a) AS TableB ON TableA.study_code=TableB.study_code LEFT JOIN  (SELECT study_code, DATE_FORMAT(MAX(STR_TO_DATE(pw_crf4b_2,'%d-%m-%Y')),'%d-%m-%Y') AS last_DOV FROM form_crf_4b GROUP BY study_code)AS TableC ON TableA.study_code=TableC.study_code 	LEFT JOIN (SELECT * FROM (SELECT b.form_crf_1_id,b.`pw_id`,b.`pw_assist_code`,	 DATE_SUB((STR_TO_DATE(b.pw_crf1_02, '%d-%m-%Y')), INTERVAL ((c.pw_crf_1_30_week*7)+c.pw_crf_1_30_days)  DAY) AS LMP  FROM form_crf_1 AS b LEFT JOIN ultrasound_examination AS c ON c.form_crf1_id=b.form_crf_1_id ) AS a WHERE a.form_crf_1_id IN (SELECT MIN(z.form_crf_1_id) FROM form_crf_1 AS z GROUP BY z.pw_assist_code)) AS ea ON ea.pw_id=a.pw_id			 WHERE c.study_code IS NOT NULL AND  d.pw_crf_3a_19='4'  AND (CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END) between 60.0 and 69.9", con);
        ...
        private void ShowGraphGridViewR4()
        {
            ...
            try
            {
                con.Open();
                MySqlCommand cmd;
                cmd = new MySqlCommand("SELECT c.study_code,(CASE WHEN e.`study_code`!='' THEN 		CONCAT(SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP)/7),'.',1)		,'.',    SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP)),'.',1)-SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP))/7,'.',1)*7) 	ELSE 			CONCAT(SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP)/7),'.',1)		,'.',    SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP)),'.',1)-SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP))/7,'.',1)*7) END) AS gestational_age,					(CASE WHEN e.`study_code`!='' THEN 'Outcome Filled' ELSE 'Ongoing' END) AS Pregnancy_Status 	,CONCAT(a.pw_crf_1_11,a.pw_crf_1_12,a.pw_crf_1_13,a.pw_crf_1_14,a.pw_crf_1_15,a.pw_crf_1_16) AS dssid,a.pw_crf_1_09 AS woman_nm,a.pw_crf_1_10 AS husband_nm, 				 last_DOV, (CASE WHEN Consumed_Choline IS NULL THEN 0 	ELSE	 Consumed_Choline END ) AS Consumed_Choline,  (DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y'))) AS Need_to_be_used, CONCAT((CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END),'%')			AS percentage FROM   pregnant_woman AS a LEFT JOIN  studies AS c ON c.pw_id=a.pw_id LEFT JOIN form_crf_3a AS d ON d.pw_id=a.pw_id LEFT JOIN form_crf_6a AS e ON e.`study_code`=d.`study_code`   		   LEFT JOIN (SELECT z.study_code, SUM(z.pw_crf4b_18b_qty) AS Consumed_Choline FROM form_crf_4b AS z GROUP BY z.study_code ) AS TableA  ON c.study_code=TableA.study_code  LEFT JOIN  (SELECT study_code, pw_crf_3a_19 AS arm,DATE_FORMAT(STR_TO_DATE(pw_crf_3a_2,'%d-%m-%Y'),'%d-%m-%Y')  AS date_of_registration FROM form_crf_3a) AS TableB ON TableA.study_code=TableB.study_code LEFT JOIN  (SELECT study_code, DATE_FORMAT(MAX(STR_TO_DATE(pw_crf4b_2,'%d-%m-%Y')),'%d-%m-%Y') AS last_DOV FROM form_crf_4b GROUP BY study_code)AS TableC ON TableA.study_code=TableC.study_code  	LEFT JOIN (SELECT * FROM (SELECT b.form_crf_1_id,b.`pw_id`,b.`pw_assist_code`,	 DATE_SUB((STR_TO_DATE(b.pw_crf1_02, '%d-%m-%Y')), INTERVAL ((c.pw_crf_1_30_week*7)+c.pw_crf_1_30_days)  DAY) AS LMP  FROM form_crf_1 AS b LEFT JOIN ultrasound_examination AS c ON c.form_crf1_id=b.form_crf_1_id ) AS a WHERE a.form_crf_1_id IN (SELECT MIN(z.form_crf_1_id) FROM form_crf_1 AS z GROUP BY z.pw_assist_code)) AS ea ON ea.pw_id=a.pw_id			WHERE c.study_code IS NOT NULL AND  d.pw_crf_3a_19='4'  AND (CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END) between 50.1 and 59.9", con);
        ...
        private void ShowGraphGridViewR5()
        {
            ...
            try
            {
                con.Open();
                MySqlCommand cmd;
                cmd = new MySqlCommand("SELECT c.study_code,(CASE WHEN e.`study_code`!='' THEN 		CONCAT(SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP)/7),'.',1)		,'.',    SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP)),'.',1)-SUBSTRING_INDEX(ABS(DATEDIFF(		STR_TO_DATE(e.pw_crf_6a_19, '%d-%m-%Y')	,ea.LMP))/7,'.',1)*7) 	ELSE 			CONCAT(SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP)/7),'.',1)		,'.',    SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP)),'.',1)-SUBSTRING_INDEX(ABS(DATEDIFF(		CURDATE()	,ea.LMP))/7,'.',1)*7) END) AS gestational_age,					(CASE WHEN e.`study_code`!='' THEN 'Outcome Filled' ELSE 'Ongoing' END) AS Pregnancy_Status 	,CONCAT(a.pw_crf_1_11,a.pw_crf_1_12,a.pw_crf_1_13,a.pw_crf_1_14,a.pw_crf_1_15,a.pw_crf_1_16) AS dssid,a.pw_crf_1_09 AS woman_nm,a.pw_crf_1_10 AS husband_nm, 				 last_DOV, (CASE WHEN Consumed_Choline IS NULL THEN 0 	ELSE	 Consumed_Choline END ) AS Consumed_Choline,  (DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y'))) AS Need_to_be_used, CONCAT((CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END),'%')			AS percentage FROM   pregnant_woman AS a LEFT JOIN  studies AS c ON c.pw_id=a.pw_id LEFT JOIN form_crf_3a AS d ON d.pw_id=a.pw_id LEFT JOIN form_crf_6a AS e ON e.`study_code`=d.`study_code`   		   LEFT JOIN (SELECT z.study_code, SUM(z.pw_crf4b_18b_qty) AS Consumed_Choline FROM form_crf_4b AS z GROUP BY z.study_code ) AS TableA  ON c.study_code=TableA.study_code  LEFT JOIN  (SELECT study_code, pw_crf_3a_19 AS arm,DATE_FORMAT(STR_TO_DATE(pw_crf_3a_2,'%d-%m-%Y'),'%d-%m-%Y')  AS date_of_registration FROM form_crf_3a) AS TableB ON TableA.study_code=TableB.study_code LEFT JOIN  (SELECT study_code, DATE_FORMAT(MAX(STR_TO_DATE(pw_crf4b_2,'%d-%m-%Y')),'%d-%m-%Y') AS last_DOV FROM form_crf_4b GROUP BY study_code)AS TableC ON TableA.study_code=TableC.study_code 	LEFT JOIN (SELECT * FROM (SELECT b.form_crf_1_id,b.`pw_id`,b.`pw_assist_code`,	 DATE_SUB((STR_TO_DATE(b.pw_crf1_02, '%d-%m-%Y')), INTERVAL ((c.pw_crf_1_30_week*7)+c.pw_crf_1_30_days)  DAY) AS LMP  FROM form_crf_1 AS b LEFT JOIN ultrasound_examination AS c ON c.form_crf1_id=b.form_crf_1_id ) AS a WHERE a.form_crf_1_id IN (SELECT MIN(z.form_crf_1_id) FROM form_crf_1 AS z GROUP BY z.pw_assist_code)) AS ea ON ea.pw_id=a.pw_id			 WHERE c.study_code IS NOT NULL AND  d.pw_crf_3a_19='4'  AND (CASE WHEN Consumed_Choline IS NULL THEN 0.0 	ELSE	 ROUND(((	Consumed_Choline	/(DATEDIFF(	STR_TO_DATE(TableC.last_DOV,'%d-%m-%Y'),		STR_TO_DATE(TableB.date_of_registration,'%d-%m-%Y')))		) * 100),1)     END) <=50.0", con);
