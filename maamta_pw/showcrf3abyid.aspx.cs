    ...
    public partial class showcrf3abyid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Session["AssismentIdCRF3a"] == null)
                {
                    Response.Redirect("showcrf3a.aspx");
                }
                lbeAssid.Text = Convert.ToString(Session["AssismentIdCRF3a"]);
                ShowData();              
            }
        }
        ...
        {
            Session["AssismentIdcrf3a"] = null;
            Session["form_crf_3a"] = null;
            Response.Redirect("showcrf3a.aspx");
        }
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select * from view_crf3a where form_crf_3a_id='" + Convert.ToString(Session["form_crf_3a"]) + "'", con);
                {
