<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="showcrf4Compliance.aspx.cs" Inherits="maamta_pw.showcrf4Compliance" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="padding-left: 2%; margin-top: 15px;">
        ...
        <div id="divExportButton" runat="server" style="text-align: right; margin-top: -17px">
            ...
            <button type="button" id="btn_Unmatched" class="btn btn-success" runat="server" style="height: 38px" onserverclick="btn_Unmatched_Click">
                Unmatched Entry &nbsp<span class="glyphicon glyphicon-export"></span>
            </button>
            <button type="button" id="btn_Pending" class="btn btn-success" runat="server" style="height: 38px" onserverclick="btn_Pending_Click">
                Pending Entry &nbsp<span class="glyphicon glyphicon-export"></span>
            </button>
        </div>
        ...
        <div style="width: 100%; height: 490px; overflow: scroll; margin-top: 10px">
            <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Record Found." AllowPaging="True" PageSize="200" OnPageIndexChanging="GridView1_PageIndexChanging" CssClass="footable" AllowSorting="false" ForeColor="#333333" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField DataField="pw_crf4_2" HeaderText="Date of Visit" />
                    <asp:BoundField DataField="pw_crf4_26" HeaderText="Required" />
                    <asp:BoundField DataField="pw_crf4_27" HeaderText="Received by PW" />
            ...
            <asp:GridView ID="GridView2" runat="server" CssClass="footable" ForeColor="#333333" AutoGenerateColumns="false">
              ...
              <%--For BMGF Export --%>
            <asp:GridView ID="GridViewExportUnmatched" runat="server" CssClass="footable"  ForeColor="#333333" AutoGenerateColumns="true">
              ...
              <%--For BMGF Export --%>
            <asp:GridView ID="GridViewExportPending" runat="server" CssClass="footable"  ForeColor="#333333" AutoGenerateColumns="true">
