<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="ancReport.aspx.cs" Inherits="maamta_pw.ancReport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div style="width: 100%; overflow: auto">
                <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Record Found." CssClass="footable" AllowSorting="false" ForeColor="#333333" AutoGenerateColumns="false">
                    <Columns>
                        ...
                        <asp:BoundField DataField="date_of_anc" HeaderText="Date of ANC" />
                        <asp:BoundField DataField="next_visit" HeaderText="Next Appointment" />
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkAssis" OnClick="Link_Assis" Text='View Report' runat="server" ToolTip="Open Report" CommandArgument='<%#Eval("assis_id")%>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
    ...
    <div style="width: 100%; height: auto; overflow: scroll; padding-left: 2%;" runat="server" id="DivReport" visible="false">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" ClientIDMode="Static" SizeToReportContent="true"></rsweb:ReportViewer>
    </div>
