<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="ErrorMissingFollowup.aspx.cs" Inherits="maamta_pw.ErrorMissingFollowup" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="color: #ff6b6b; font-size: 22px; width: 100%">
            Followup Missed During Enrollment (Error)
        </div>
