<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="ancSerialMissed.aspx.cs" Inherits="maamta_pw.ancSerialMissed" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="color: #ff6b6b; font-size: 22px; width: 100%">
            <b>ANC Serial No. (Incomplete or Missed): </b>
        ...
        <div style="width: 100%; overflow: auto">
            <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Record Found."  CssClass="footable" AllowSorting="false" ForeColor="#333333" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField DataField="anc_visit_id" HeaderText="anc_visit_id" />
                    <asp:BoundField DataField="assis_id" HeaderText="Assisment ID" />
                    <asp:BoundField DataField="DOV" HeaderText="ANC Date" />
                    <asp:BoundField DataField="woman_nm" HeaderText="Woman Number" />
                    <asp:BoundField DataField="husband_nm" HeaderText="Husband Name" />
                    <asp:BoundField DataField="dssid" HeaderText="DSSID" />
                    <asp:BoundField DataField="pw_status" HeaderText="pw_status" />
                    <asp:BoundField DataField="anc_visit_48" HeaderText="Serial No. (Q48)" />
