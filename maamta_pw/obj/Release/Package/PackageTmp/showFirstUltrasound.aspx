<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="showFirstUltrasound.aspx.cs" Inherits="maamta_pw.showFirstUltrasound" %>
        ...
        <div style="width: 100%; height: 490px; overflow: scroll; margin-top: 10px">
            <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Record Found." AllowPaging="True" PageSize="200" OnPageIndexChanging="GridView1_PageIndexChanging" CssClass="footable" AllowSorting="false" ForeColor="#333333" AutoGenerateColumns="false">
             <Columns>
                    ...
                    <asp:BoundField DataField="no_of_fetus" HeaderText="Number of Fetus" />
                    ...
                    <asp:BoundField DataField="pw_crf_1_30_week" HeaderText="Weeks" />
                    <asp:BoundField DataField="pw_crf_1_30_days" HeaderText="Days" />
                    <asp:BoundField DataField="pw_crf_1_37" HeaderText="Description" />
                    <asp:BoundField DataField="end_time" HeaderText="End Time" />
                    <asp:BoundField DataField="sra_name" HeaderText="SRA Name" />
                </Columns>
