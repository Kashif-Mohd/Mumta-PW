<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="showcrf3c.aspx.cs" Inherits="maamta_pw.showcrf3c" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="padding-left: 2%; margin-top: 15px;">
        ...
        <div style="color: #ff6b6b; font-size: 22px; width: 100%">
            Baseline Anthro and Treatment Form: 
        ...
        <div style="width: 100%; height: 490px; overflow: scroll; margin-top: 10px">
            <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Record Found." AllowPaging="True" PageSize="200" OnPageIndexChanging="GridView1_PageIndexChanging" CssClass="footable" AllowSorting="false" ForeColor="#333333" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField DataField="pw_crf3c_2" HeaderText="pw_crf3c_2" />
                    <asp:BoundField DataField="pw_crf3c_3" HeaderText="pw_crf3c_3" />
                    ...
                    <asp:BoundField DataField="pw_crf3c_15" HeaderText="pw_crf3c_15" />
                    <asp:BoundField DataField="pw_crf3c_16" HeaderText="pw_crf3c_16" />
                    <asp:BoundField DataField="pw_crf3c_17" HeaderText="pw_crf3c_17" />
                    <asp:BoundField DataField="pw_crf3c_18" HeaderText="pw_crf3c_18" />
                    <asp:BoundField DataField="pw_crf3c_19" HeaderText="pw_crf3c_19" />
                    <asp:BoundField DataField="pw_crf3c_20" HeaderText="pw_crf3c_20" />
                    <asp:BoundField DataField="pw_crf3c_24" HeaderText="pw_crf3c_24" />
                    <asp:BoundField DataField="pw_crf3c_25" HeaderText="pw_crf3c_25" />
