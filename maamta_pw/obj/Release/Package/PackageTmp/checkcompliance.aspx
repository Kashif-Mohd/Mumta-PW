<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="checkcompliance.aspx.cs" Inherits="maamta_pw.checkcompliance" Culture="ar-DZ" %>
    ...
    <div>
        ...
        <div style="background-color: #095e66; margin: 0 0 10px 10px; -moz-box-shadow: 0 6px 6px -6px gray; box-shadow: 0 6px 6px -6px gray;">
            <h2 style="text-align: center; margin-top: 10px; font-size: 26px; color: white; text-transform: capitalize; background-color: #55efc4; padding-top: 6px; padding-bottom: 5px; font-family: Arial">
                <b>Update Compliance (Empty Sachet)</b></h2>
        </div>
        ...
        <asp:Panel ID="Panel2" runat="server">
            ...
            <div id="divExportButton" runat="server" style="text-align: right; margin-top: -2px">
                ...
                <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Record Found." AllowPaging="True" PageSize="200" OnPageIndexChanging="GridView1_PageIndexChanging" CssClass="footable" AllowSorting="false" ForeColor="#333333" AutoGenerateColumns="false">
                    <Columns>
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <asp:LinkButton ID="Link_id" OnClick="Link_EditForm" Text='Edit' runat="server" ToolTip="Update Record" CommandArgument='<%#Eval("study_code")+","+ Eval("dssid")+","+ Eval("last_date_of_attempt")+","+ Eval("date_of_attempt")+","+ Eval("empty_sachet")+","+ Eval("actual_empty_sachet")+","+ Eval("remarks")+","+ Eval("id")%>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="Required" HeaderText="Required Sachet" />
                        <asp:BoundField DataField="empty_sachet" HeaderText="Received Sachet" />
                        <asp:BoundField DataField="actual_empty_sachet" HeaderText="Actual Received Sachet" />
            ...
            <asp:GridView ID="GridView2" runat="server" CssClass="footable" ForeColor="#333333" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField DataField="woman_nm" HeaderText="Woman Name" />
                    <asp:BoundField DataField="husband_nm" HeaderText="Husband Name" />
                    <asp:BoundField DataField="last_date_of_attempt" HeaderText="Last Date of Visit" />
                    <asp:BoundField DataField="date_of_attempt" HeaderText="Date of Visit" />
                    <asp:BoundField DataField="Required" HeaderText="Required Sachet" />
                    <asp:BoundField DataField="empty_sachet" HeaderText="Received Sachet" />
                    <asp:BoundField DataField="actual_empty_sachet" HeaderText="Actual Received Sachet" />
