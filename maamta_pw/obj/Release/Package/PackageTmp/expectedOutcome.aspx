<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="expectedOutcome.aspx.cs" Inherits="maamta_pw.expectedOutcome" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="color: #ff6b6b; font-size: 22px; width: 100%">
            <b>Expected Outcome: </b>(by Ultrasound)
