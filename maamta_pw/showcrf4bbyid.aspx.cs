    ...
    public partial class showcrf4bbyid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Session["StudyIdCRF4b"] == null)
                {
                    Response.Redirect("showcrf4b.aspx");
                }
                lbeStudyID.Text = Convert.ToString(Session["StudyIdCRF4b"]);
                ShowData();
        ...
        {
            Session["StudyIdCRF4b"] = null;
            Session["form_crf_4b_id"] = null;
            Response.Redirect("showcrf4b.aspx");
        }
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select * from view_crf4b where form4b_id='" + Convert.ToString(Session["form_crf_4b_id"]) + "'", con);
                {
