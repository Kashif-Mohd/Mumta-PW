<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="showcrf5b.aspx.cs" Inherits="maamta_pw.showcrf5b" %>
            ...
            <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Record Found." AllowPaging="True" PageSize="200" OnPageIndexChanging="GridView1_PageIndexChanging" CssClass="footable" AllowSorting="false" ForeColor="#333333" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Study-ID">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkStudyID" OnClick="Link_StudyID" Text='<%#Eval("study_code") %>' runat="server" ToolTip="Form Detail" CommandArgument='<%#Eval("form_crf_5b_id")+","+ Eval("study_code")%>'></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="followup_num" HeaderText="followup_num" />
                    <asp:BoundField DataField="pw_crf5b_2" HeaderText="pw_crf5b_2" />
                    <asp:BoundField DataField="pw_crf5b_3" HeaderText="pw_crf5b_3" />
                    ...
                    <asp:BoundField DataField="pw_crf5b_18" HeaderText="pw_crf5b_18" />
                    <asp:BoundField DataField="refused_reason" HeaderText="refused_reason" />
                    <asp:BoundField DataField="pw_crf5b_19" HeaderText="pw_crf5b_19" />
                    <asp:BoundField DataField="pw_crf5b_20" HeaderText="pw_crf5b_20" />
                    <asp:BoundField DataField="pw_crf5b_21" HeaderText="pw_crf5b_21" />
                    <asp:BoundField DataField="pw_crf5b_22" HeaderText="pw_crf5b_22" />
                    <asp:BoundField DataField="pw_crf5b_46" HeaderText="pw_crf5b_46" />
                    <asp:BoundField DataField="pw_crf5b_47" HeaderText="pw_crf5b_47" />
                    <asp:BoundField DataField="pw_crf5b_48" HeaderText="pw_crf5b_48" />
                    <asp:BoundField DataField="pw_crf5b_49" HeaderText="pw_crf5b_49" />
                    <asp:BoundField DataField="pw_crf5b_50" HeaderText="pw_crf5b_50" />
                    <asp:BoundField DataField="pw_crf5b_51" HeaderText="pw_crf5b_51" />
                    <asp:BoundField DataField="pw_crf5b_52" HeaderText="pw_crf5b_52" />
                    <asp:BoundField DataField="pw_crf5b_53" HeaderText="pw_crf5b_53" />
                    <asp:BoundField DataField="pw_crf5b_54" HeaderText="pw_crf5b_54" />
                    <asp:BoundField DataField="pw_crf5b_55" HeaderText="pw_crf5b_55" />
