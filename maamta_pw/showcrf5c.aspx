<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="showcrf5c.aspx.cs" Inherits="maamta_pw.showcrf5c" %>
        ...
        <div style="width: 100%; height: 490px; overflow: scroll; margin-top: 10px">
            <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Record Found." AllowPaging="True" PageSize="200" OnPageIndexChanging="GridView1_PageIndexChanging" CssClass="footable" AllowSorting="false" ForeColor="#333333" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField DataField="form_crf_5c_id" HeaderText="form_crf_5c_id" />
                    <asp:TemplateField HeaderText="Study-ID">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkStudyID" OnClick="Link_StudyID" Text='<%#Eval("study_code") %>' runat="server" ToolTip="Form Detail" CommandArgument='<%#Eval("form_crf_5c_id")+","+ Eval("study_code")%>'></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="followup_num" HeaderText="followup_num" />
                    <asp:BoundField DataField="pw_crf5c_2" HeaderText="pw_crf5c_2" />
                    <asp:BoundField DataField="pw_crf5c_3" HeaderText="pw_crf5c_3" />
                    ...
                    <asp:BoundField DataField="pw_crf5c_19" HeaderText="pw_crf5c_19" />
                    <asp:BoundField DataField="refused_reason" HeaderText="refused_reason" />
                    <asp:BoundField DataField="pw_crf5c_20" HeaderText="pw_crf5c_20" />
                    <asp:BoundField DataField="pw_crf5c_21" HeaderText="pw_crf5c_21" />
                    <asp:BoundField DataField="pw_crf5c_22" HeaderText="pw_crf5c_22" />
                    <asp:BoundField DataField="pw_crf5c_23" HeaderText="pw_crf5c_23" />
                    <asp:BoundField DataField="pw_crf5c_25" HeaderText="pw_crf5c_25" />
                    <asp:BoundField DataField="pw_crf5c_27" HeaderText="pw_crf5c_27" />
                    <asp:BoundField DataField="pw_crf5c_30" HeaderText="pw_crf5c_30" />
