    ...
    public partial class showcrf2byid : System.Web.UI.Page
    {
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select * from view_crf2 where crf2_id='" + Convert.ToString(Session["form_crf_2"]) + "'", con);
                {
        ...
        private void ShowMUAC()
        {
            ...
            {
                con.Open();
                MySqlCommand cmd = new MySqlCommand("select * from muac_crf_2 where form_crf_2_id='" + Convert.ToString(Session["form_crf_2"]) + "' ", con);
                {
                    MySqlDataAdapter sda = new MySqlDataAdapter();
                    {
                        cmd.Connection = con;
        ...
        private void ShowWeight()
        {
            ...
            {
                con.Open();
                MySqlCommand cmd = new MySqlCommand("select * from pw_weight_crf_2 where form_crf_2_id='" + Convert.ToString(Session["form_crf_2"]) + "' ", con);
                {
                    MySqlDataAdapter sda = new MySqlDataAdapter();
                    {
                        cmd.Connection = con;
        ...
        private void ShowHeight()
        {
            ...
            {
                con.Open();
                MySqlCommand cmd = new MySqlCommand("select * from pw_height_crf_2 where form_crf_2_id='" + Convert.ToString(Session["form_crf_2"]) + "' ", con);
                {
                    MySqlDataAdapter sda = new MySqlDataAdapter();
                    {
                        cmd.Connection = con;
