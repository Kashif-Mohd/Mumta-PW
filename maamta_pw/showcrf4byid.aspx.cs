...
namespace maamta_pw
{
    public partial class showcrf4byid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Session["StudyIdCRF4"] == null)
                {
                    Response.Redirect("showcrf4.aspx");
                }
                lbeStudyID.Text = Convert.ToString(Session["StudyIdCRF4"]);
                ShowData();
        ...
        {
            Session["StudyIdCRF4"] = null;
            Session["form_crf_4_id"] = null;
            Response.Redirect("showcrf4.aspx");
        }
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select * from view_crf4 where form_crf_4_id='" + Convert.ToString(Session["form_crf_4_id"]) + "'", con);
                {
