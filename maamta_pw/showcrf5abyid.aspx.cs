    ...
    public partial class showcrf5abyid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Session["StudyIdCRF5a"] == null)
                {
                    Response.Redirect("showcrf5a.aspx");
                }
                lbeStudyID.Text = Convert.ToString(Session["StudyIdCRF5a"]);
                ShowData();
        ...
        {
            Session["StudyIdCRF5a"] = null;
            Session["form_crf_5a_id"] = null;
            Response.Redirect("showcrf5a.aspx");
        }
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select * from view_crf5a where form_crf_5a_id='" + Convert.ToString(Session["form_crf_5a_id"]) + "'", con);
                {
