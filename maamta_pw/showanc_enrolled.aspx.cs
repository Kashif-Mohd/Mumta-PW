...
namespace maamta_pw
{
    public partial class showanc_enrolled : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                DateFormatPageLoad();
                Session["WebForm"] = "showanc_enrolled";
                ShowData();
                txtdssid.Focus();
        ...
        public void ExcelExport()
        {
            ...
            {
                Response.Clear();
                Response.AddHeader("content-disposition", "attachment;filename=ANC-Enrolled (" + DateTime.Today.ToString("dd-MM-yyyy") + ").xls");
                Response.Charset = "";
