<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="showanc_enrolled_labeled.aspx.cs" Inherits="maamta_pw.showanc_enrolled_labeled" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div style="padding-left: 2%; margin-top: 15px;">
        ...
        <div style="color: #ff6b6b; font-size: 22px; width: 100%">
            ANC Visit Labeled (Enrolled Participant)
