...
namespace maamta_pw
{
    public partial class showcrf6a : System.Web.UI.Page
    {
        ...
        public void ExcelExport()
        {
            ...
            {
                Response.Clear();
                Response.AddHeader("content-disposition", "attachment;filename=CRF6a (" + DateTime.Today.ToString("dd-MM-yyyy") + ").xls");
                Response.Charset = "";
